#!/usr/bin/env python3
"""Keyboard teleop for the Gazebo rover (mrsim test rig).
...
Launch:
  ros2 launch mrsim farm.launch.py mode:=teleop gui:=true
"""
import math
import os
import select
...
try:
    ...
    from mrsim.rover_reset import Respawn, spawn_pose
...
class TeleopNode(Node):
    def __init__(self):
        super().__init__("multiroi_teleop")
